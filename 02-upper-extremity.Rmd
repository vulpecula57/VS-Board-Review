...
**What are the zones of the upper
extremity?**[@illig57UpperExtremity2019]
...
**What are some common exposures for major upper extremity
arteries?**[@illig57UpperExtremity2019;
@garygwindAnatomicExposuresVascular2013]

1.  **Proximal Right Subclavian Artery:** Access through a median
    sternotomy.

2.  **Proximal Left Subclavian Artery:** An anterolateral thoracotomy is
...
3.  **Mid and Distal Subclavian Artery**: Access through a
...
5.  **Brachial Artery, Upper Arm:** The brachial artery's superficial
...
6.  **Brachial Artery, Antecubital Fossa:** Exposure of the brachial
...
8.  **Ulnar Artery:** The ulnar artery courses beneath the superficial
...
subclavian (1-2%).[@dumfarth2015]

1.  **Bovine Arch:** Where the innominate and left common carotid
    arteries share a common origin.[@layton2006]

2.  **Aberrant Vertebral Artery:** Where the vertebral artery arises
    directly from the aortic arch.

3.  **Aberrant Right Subclavian Artery:** Where there is no innominate
...
-   Upper extremity ischemia \<5% of patients with limb ischemia and in
    ...
    contributor to upper extremity ischemia[@shuja117UpperExtremity]
...
-   Surgery:
    ...
    -   Bypass from aortic arch through median sternotomy - Most durable
        ...
        appropriate if disease involves the origin.[@aiello2011;
    ...
    -   Ipsilateral CCA to subclavian artery (bypass or transposition) -
        ...
        determined by anatomic constraints.[@cinà2002; @vandervliet1995]
        ...
        with autologous vein.[@aburahma2000; @illuminati2018;
        @ziomek1986]
        ...
        -   **How does the exposure differentiate in transposition vs
            bypass?**
        ...
        -   **What are some common complications after carotid
        ...
        -   **When carotid-subclavian bypass compared to
            transposition?**

            1.  Vertebral artery takes origin from the subclavian artery
                in a very proximal position or is dominant over the
                contralateral side, then bypass preferred.
                [@moraschTechniqueSubclavianCarotid2009d]

            2.  For coronary-subclavian steal with patent internal
...
-   Endovascular: PTA evidence is anecdotal with stents for lesions
    unresponsive to PTA or dissection following angioplasty.[@cheun2019;
    @nasser2014; @dineen2007]
...
-   Surgery: GSV vein bypass remains standard for revascularization with
    ...
    snuffbox.[@chang2003; @masden2012; @spinelli2010]
...
1.  Primary: Raynaud's disease-idiopathic form that is a benign process
...
2.  Secondary: Fixed vascular obstruction to blood flow decreasing
...
arteritis[@jacklcronenwettVascularDecisionMaking2020; @lejoncour2018]
...
3.  Criteria (ACR)
    ...
    6.  Arteriographic evidence of narrowing/occlusion in aorta/primary
        branches/or large upper/lower extremity arteries

4.  Initial therapy for acute vasculitis should include steroids and
    ...
    bypass with jump graft to involved visceral vessels.[@ehlert2019]
...
-   Iatrogenic complications - Seen in 1-3% of brachial artery access -
    ...
    sheaths.[@treitl2015] More on appropriate access technique can be
...
Small pseudoaneurysms \<3cm have a high rate of spontaneous thrombosis.
...
+=====================+======================+======================+
| **Transa xillary**  | Cosmetically more    | Difficult to         |
|                     | appealing as it has  | visualize the        |
|                     | a limited hidden     | anatomy, dependent   |
|                     | scar                 | on good assistance   |
|                     |                      |                      |
...
|                     |                      | patch vein.          |
+---------------------+----------------------+----------------------+
| -   \*Supracla      | Good for scalene     | Unable to decompress |
|                     | triangle access and  | venous compression   |
|     vicular\*\*     | debulking and        | or visualize vein    |
|                     | cervical rib         | adequately           |
|                     | resection            |                      |
|                     |                      | Cosmetically less    |
|                     | Required for aTOS if | appealing            |
|                     | arterial             |                      |
|                     | reconstruction       |                      |
|                     | necessary            |                      |
+---------------------+----------------------+----------------------+
| -   \*Infracla      | Good access for      | Unable to expose     |
|                     | venous decompression | subclavian artery or |
|     vicular\*\*     |                      | decompress brachial  |
|                     | Allows for excision  | plexus.              |
|                     | of subclavius muscle |                      |
|                     | and costoclavicular  | Difficult to access  |
|                     | ligament             | most posterior       |
|                     |                      | aspect of rib        |
|                     |                      |                      |
|                     |                      | Cosmetically less    |
|                     |                      | appealing            |
+---------------------+----------------------+----------------------+
| **Paracla vicular** | Useful if mixed      | Requires two         |
|                     | etiology TOS to      | incisions one above  |
|                     | adequately           | and below the        |
|                     | decompression all    | clavicle             |
|                     | neurovascular        |                      |
|                     | structures           |                      |
+---------------------+----------------------+----------------------+
