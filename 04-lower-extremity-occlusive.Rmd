...
by Fontaine (1954) [@fontaineSurgicalTreatmentPeripheral1954] followed 
...
+:==========:+:===========:+:=============================:+
| 0          | 0           | Asymptomatc -no haemodynamic  |
...
[@frederick2010; @leriche1948; @setacci2012]
...
+--------------+--------------+--------------+--------------+
| Stenosis     | Peak         | Velocity     | Distal       |
| Category     | Systolic     | Ratio        | Artery       |
|              | Velocity     |              | Spectral     |
|              |              |              | Waveform     |
+:============:+:============:+:============:+:============:+
| Normal       | \<150        | \<1.5        | Triphasic,   |
|              |              |              | Normal PSV   |
+--------------+--------------+--------------+--------------+
...
-   **Anti-Platelet Therapy:** Aspirin therapy (75-325mg daily) is recommended to
...
-   **Hypertension** -- Indicated B-Blockers for hypertension 
    *(Grade 1-Level B)* (there's no evidence that Beta Blockers worsens IC)
...
**How does PAOD pathologically progress clinically into Chronic Limb Threatening 
 Ischaemia (CLTI)? **
...
| Grade        | Category     | Clinical Description            |
+:============:+:============:+:===============================:+
| 0            | 0            | Asymptomatic -no haemodynamic   |
|              |              | significant occlusive disease   |
+--------------+--------------+---------------------------------+
| I            | 1            | Mild Claudication               |
+--------------+--------------+---------------------------------+
...
-   Foot Infection - Signs of infection, erythema, rubor, cellulitis,
    ...
    prompt urgent referal.[@kalish2010]
...
+ The target population were:
    ...
    2. ***Diabetic Foot Ulcer*** or any lower limb ulceration present for 
       at least 2 weeks.
...
Methodology of the guidelines utilised the structure of the ***GRADE***
...
level of evidence is generally **LOW**. Again, it is important to highlight
...
to correlate with Amputation free survival and wound healing: Amputation Free
 Survival TP \<30mmHg 2.13 HR (1.52-2.98). [@wickström2017; @hicks2018]
...
40mmHg has the greatest correlation with amputation stump healing.[@malone1987]
...
+  **High-intensity statin therapy** to reduce all-cause and cardiovascular
    mortality - Atorvastatin 80mg or Rosuvastatin 40mg (*Grade 1 Level
    A*) [@arya2018; @2013acc]
...
of early osteomyelitis with negative x-ray may warrent an MRI.[@giurato2017]
...
concept of 'in-line pulsatile flow to the foot'), **GLASS** focusses on 
...
recommendation for Management?**
  ...
  + Offer Revascularisation to all "average surgical risk patients" (\\\<5%
    ...
    have good saphenous vein. *Grade 1 (Strong) Level of Evidence C (Low)*
    [@adam2005; @norgren2007]
...
**What evidence do we have for deciding between Endo and Open management? 
What is the BASIL trial?**

The evidence is largely of poor quality, and is largely retrospective or 
non-controlled, or industry sponsored. **BASIL** (Bypass versus Angioplasty
...
poor but limb salvage is reasonable.[@popplewell2019; @kayssi2016;
@mustapha2016]
...
ABPI and duplex to establish a new baseline after intervention.[@zierler2018;
@mohler2012]
...
-    A mal perforans ulcer over the right first metatarsal head with long
    ...
    angiosome with the shortest bypass.[@hingorani2016; @jongsma2017]

#### Complications

**What are some complications of lower extermity revascularization
procedures?**
...
management during femoral exploration.[@obara2014; @weaver2014]
...
**What is the patient presentation of ALI? Are there any differences between
...
+   ***Pulseless***: Self explanatory. It is worth examining the contralateral 
...
+   ***Paresthesia and Paralysis*** are the last two Ps. Paresthesia is an
...
+-------------+----------------+---------+---------+---------+---------+
| Cla         | Prognosis      | Sensory | Muscle  | A       | Venous  |
| ssification |                | Loss    | W       | rterial | Signal  |
|             |                |         | eakness | Signal  |         |
+=============+:==============:+:=======:+:=======:+:=======:+:=======:+
| I . Viable  | Not            | None    | None    | Present | Present |
|             | immediately    |         |         |         |         |
|             | threatened     |         |         |         |         |
+-------------+----------------+---------+---------+---------+---------+
| II\.        | \              | \       | \       |         |         |
| Threatened  |                |         |         |         |         |
+-------------+----------------+---------+---------+---------+---------+
| a .         | Salvageable if | Minimal | None    | Weak/   | Present |
| Marginally  | promptly       | (toes)  |         | absent  |         |
|             | treated        | or none |         |         |         |
|             | (\<24hr)       |         |         |         |         |
+-------------+----------------+---------+---------+---------+---------+
| b .         | Salvageable    | More    | Mild,   | Absent  | Absent  |
| Immediately | with immediate | than    | m       |         |         |
|             | revasc (\<6hr) | toes    | oderate |         |         |
+-------------+----------------+---------+---------+---------+---------+
| III\.       | Major tissue   | P       | P       | Absent  | Absent  |
| I           | loss or        | rofound | rofound |         |         |
| rreversible | permanent      | ane     | pa      |         |         |
|             | nerve damage   | sthetic | ralysis |         |         |
|             | inevitable;    |         | (rigor) |         |         |
|             | Minimal        |         |         |         |         |
|             | benefit from   |         |         |         |         |
|             | revasc         |         |         |         |         |
...
**What does the work up for ALI entail? How is the diagnosis
made?**
...
most immediate and best imaging of the tibial vessels. [@creagerClinicalPracticeAcute2012;
...
+   ***Anticoagulation***: IV unfractionated heparin should be immediately
...
+   **Open Surgical Management**:
    ...
    -   ***Endarterectomy*** -- not necessarily required but might be used for
...
+   **Class I** patients might just need medical therapy like anticoagulation 
...
+ Related Studies:
    ...
    -   ***Meta Analysis***: Originally published in 2002 but updated
...
and/or renal failure. [@obaraAcuteLimbIschemia2018] Treatment of this is largely 
...
+   **Physical Exam**: Tenderness, (especially over anterior compartment)
    ...
    -   ***Deep Posterior Compartment***: Sensory distribution and muscular 
        innervation from the tibial nerve[@velmahos2002].
...
-   **Forearm and Upper Arm Fasciotomies**: Often performed by orthopedic
...
-   **Lower Leg**: The most common type is a lower leg 4 compartment fasciotomy
...
4.  After hemostasis loose dressings should be applied. The leg
...
head of the gastrocnemius muscle.[@gokkus2014; @lejay2014] Type IV PAES
