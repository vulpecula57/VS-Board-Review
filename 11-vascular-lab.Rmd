...
-   MRA - is performed with gadolinium-based contrast and is not appropriate
...
throughout diastole, but less as compared to the ICA due to the high-resistance influence of the ECA.
...
-   Three primary views: temporal, foraminal (occipital), orbital views
    ...
    -   **Temporal view:** Used to interrogate PCA, ACA, MCA, and ICA.
        The MCA, ICA and PCA flow direction is towards the probe, the ACA flow direction is away.
...
-   Vasomotor activity can be evaluated as well with TCD. Hypercapnia or
    ...
    Hypocapnia will result in decreased flow. No change in response to hyper or
...
vascular surgeons a notable portion of their practice: hemodialysis access, and specifically fistulas.
...
This typically uses 4 cuffs. High thigh cuff should be 30% greater than brachial
...
requires test cessation. The point when the patient reports pain starts is
...
and WBC scans may be positive up to 4 months after implantation, so do not
...
Also known as thromboangiitis obliterans, this is a rare disease, but with characteristic findings on ultrasound of
...
Angiography will often show a classic "scimitar" sign - a smooth well-defined crescent-shaped defect.[@shaw2007; @winn2015]
...
often occurs within the first 30 days after liver transplantation, with an
